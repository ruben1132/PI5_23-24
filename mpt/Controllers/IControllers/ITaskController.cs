...
namespace Mpt.IControllers
{
    public interface ITasksController
    {
        ...
        Task<ActionResult<IEnumerable<TaskDto>>> GetAll([FromQuery] string type, [FromQuery] bool? isApproved, [FromQuery] string? user);
        Task<ActionResult<IEnumerable<TaskSimpleDto>>> GetMyTasks([FromQuery] string type, [FromQuery] bool? isApproved);
