...
const ThreeJSPage = () => {
  useEffect(() => {
    // Place your Three.js initialization code here
    // Make sure to adjust any resource URLs to be relative to your Next.js app
  }, []);
    ...
    <div id="container">
        ...
        <div id="keyboard-help-panel">
            <table className="keyboard-help" id="keyboard-help-table">
                ...
                <tr>
                    <th colSpan={2} style={{textAlign: "left"}}>Set view mode</th>
                </tr>
                <tr>
                    <td></td>
                ...
                <tr>
                    <th colSpan={2} style={{textAlign: "left"}}>Display / select / hide views</th>
                </tr>
                <tr>
                    <td></td>
                    <td>Fixed view</td>
                ...
                <tr>
                    <th colSpan={2} style={{textAlign: "left"}}>Display / hide subwindows and bounding volumes</th>
                </tr>
                <tr>
                    <td></td>
                    <td>Mini-map</td>
                ...
                <tr>
                    <th colSpan={2} style={{textAlign: "left"}}>Turn on / off lights, shadows and fog
                    </th>
                </tr>
                <tr>
                    <td></td>
