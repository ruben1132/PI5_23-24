...
export default class UserInterface extends GUI {
    constructor(thumbRaiser) {
        ...
        const cubeTexturesParameters = {
            name: thumbRaiser.cubeTexturesParameters.skyboxes[thumbRaiser.cubeTexturesParameters.selected].name,
        };
        ...
        const directionalLightParameters = {
            color: '#' + new THREE.Color(thumbRaiser.directionalLight.color).getHexString(),
        };
        ...
        const collisionDetectionParameters = {
            method: thumbRaiser.collisionDetectionParameters.method == 'bc-aabb' ? 'BC / AABB' : 'OBB / AABB',
        };
