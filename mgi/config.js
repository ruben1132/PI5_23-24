...
export default {
    ...
    routesPermissions: {
        ...
        floor: {
            ...
            getByCode: [roles.GESTOR_CAMPUS, roles.GESTOR_FROTA, roles.GESTOR_TAREFAS],
        ...
        passage: {
            ...
            getByDesignation: [roles.GESTOR_CAMPUS, roles.GESTOR_FROTA, roles.GESTOR_TAREFAS],
        ...
        room: {
            ...
            get: [...Object.values(roles)],
            getById: [roles.GESTOR_CAMPUS, roles.GESTOR_FROTA, roles.GESTOR_TAREFAS],
            getByName: [roles.GESTOR_CAMPUS, roles.GESTOR_FROTA, roles.GESTOR_TAREFAS],
            put: [roles.GESTOR_CAMPUS],
            delete: [roles.GESTOR_CAMPUS],
        },
        taskType: {
